...
export function randomControlled(n,length) {
...
export function generateBackgroundTexture(p) {
    var size = 512;
...
export function createBackground(material) {
...
export function findChild(element, className) {
